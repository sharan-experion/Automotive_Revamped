import {
  FcAutomotive, FcExternal, FcViewDetails, FcReadingEbook, FcCalculator, FcComboChart,
} from 'react-icons/fc';
  ...
  return (
    ...
    <table className={classes.userloggedin}>
      ...
      <tr>
        <td>
          <Link to="/addProduct">
            <FcExternal size="150px" className={classes.icon} />
          </Link>
        ...
        <td>
          ...
          <Link to="/employeeDetails">
            <FcReadingEbook size="150px" className={classes.icon} />
          </Link>
      ...
      <tr>
        ...
        <td>
          <Link to="/estimationDetails">
            <FcCalculator size="150px" className={classes.icon} />
          </Link>
