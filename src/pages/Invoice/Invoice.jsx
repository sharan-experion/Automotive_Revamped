...
function Invoice() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://127.0.0.1:8000/estimate/estimateproducts/${estimId}`)
      .then((res) => {
        console.log(prodDetails);
        setprodDetails(res.data);
        axios.get(`http://127.0.0.1:8000/estimate/estimateservices/${estimId}`)
          .then((response) => {
...
return (
  <div className={classes.jobcard}>
    <div ref={componentRef}>
      <h1 className="text-center">AUTOMOTIVE</h1>
      <table>
        <thead>
          <tr>
